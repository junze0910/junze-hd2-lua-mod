...
-- ===========================================================================
--  更均衡的爱国者/解放者外骨骼 · 携带爱国者版（外骨骼三件套 v1.0）
--
...
--  ③ StratagemSettings · 爱国者外骨骼（StratagemType_PatriotExosuit） 的召唤战备
--       additional_stratagem（"战备附加"槽） 0 → 10（= StratagemType_EmancipatorExosuit）
--       即：**需携带爱国者** —— 召唤爱国者时额外附带解放者（10 号战备）
--
...
report(('已加载 v1.0·携带爱国者版（更均衡的爱国者/解放者外骨骼：EXO-49 槽1→加特林炮塔 / EXO-45 槽0→左臂加农炮 / 召唤爱国者额外附带 %d 号战备 = 解放者））；前置 loader v%s / API %s（来源 %s）'):format(
